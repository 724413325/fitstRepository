(function($){
	$.fn.dailog = function(options,callBack){
		var _this = this;
		var wx_str=$("#wx_str_id").text();
	    var defaultDailog = {
	      width:              280,                    	  //宽度
	      height:             'auto',                     //高度
	      padding:            '10px 16px',                //padding
	      title:              '温馨提示!',                    //提醒信息
	      discription:        '请添加本事堂微信<br /><b><span style="color:#FF0000;background:yellow; color:red "><nobr><span class="wx_str">'+wx_str+'</span></nobr></span><br />点击复制</b>',          //描述
	      borderRadius:       '4px',                      //圆角
	      bottons:            ['确定','取消'],            //按钮信息
	      maskBg:             'rgba(0,0,0,0.6)',          //遮罩层背景色
	      dailogBg:           '#c0f9d9',                     //弹出框的背景色
